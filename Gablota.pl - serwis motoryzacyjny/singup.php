...
<body>
  ...
  <main class="main">
    <section class="singup">
      ...
      <form action="singupconf.php" method="POST">
        <input class="input-line" type="text" placeholder="Imie" name="imie" required>
        <input class="input-line" type="text" placeholder="Nazwisko" name="nazwisko" required>
        <input class="input-line" type="text" placeholder="Miejscowość" name="miejscowosc">
        <input class="input-line" type="tel" placeholder="Telefon" name="telefon" required>
        <input class="input-line" type="email" placeholder="Email" name="email" required>
        <input class="input-line" type="password" placeholder="Hasło" name="haslo" required>
        <input class="input-line" type="password" placeholder="Powtórz hasło" name="haslo2" required>
        <button class="button-confirm" type="submit">Zarejestruj</button>
      </form>
      <a href="singin.php" class="singin__singup link-reset">Mam konto - zaloguj</a>
    </section>
  </main>
